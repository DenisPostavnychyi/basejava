...
import main.storage.serializer.StreamSerializer;
...
public class FileStorage extends AbstractStorage<File> {
    ...
    private StreamSerializer streamSerializer = new ObjectStreamSerializer();
    ...
    public int size() {
        ...
        if (list == null) {
            throw new StorageException("Directory has no file");
        }
        return list.length;
    }
